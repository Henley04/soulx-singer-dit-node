// Type definitions for soulx-singer-dit-win32-x64-vulkan 0.1.0
//
// This subpackage is a thin loader around the prebuilt `vulkan.node` binary
 ...
 * subpackage always loads the Vulkan binary.
 */
...
/**
 * A loaded SoulX-Singer-DiT model backed by the Vulkan binary.
