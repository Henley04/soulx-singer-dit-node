// Type definitions for soulx-singer-dit-darwin-arm64-cpu 0.1.1
//
// This subpackage is a thin loader around the prebuilt `cpu.node` binary and
// re-exports the native surface. The authoritative, full type definitions
// live in the main `soulx-singer-dit` package (../../index.d.ts); the
// declarations below are a self-contained minimal mirror of the native
// export surface so that direct imports of this subpackage still type-check.
//
 ...
 * subpackage always loads the CPU binary.
 */
...
/**
 * A loaded SoulX-Singer-DiT model backed by the CPU binary.
